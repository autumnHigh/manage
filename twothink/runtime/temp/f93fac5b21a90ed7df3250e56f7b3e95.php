<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\aathink\twothink\public/../application/admin/view/default/repairs\index.html";i:1542017566;s:77:"D:\aathink\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
				...
				<?php if(!(empty($repairs) || (($repairs instanceof \think\Collection || $repairs instanceof \think\Paginator ) && $repairs->isEmpty()))): if(is_array($repairs) || $repairs instanceof \think\Collection || $repairs instanceof \think\Paginator): $i = 0; $__LIST__ = $repairs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repair): $mod = ($i % 2 );++$i;?>
					<tr>
						...
						<td>
							...
							<a title="删除" href="<?php echo url('del?id='.$repair['id']); ?>">删除</a>
						</td>
					</tr>
