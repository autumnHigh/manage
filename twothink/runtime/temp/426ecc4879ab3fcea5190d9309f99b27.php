<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\aathink\twothink\public/../application/admin/view/default/channel\edit.html";i:1542007375;s:77:"D:\aathink\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">要检修人员姓名<span class="check-tips">（用于显示的维修账户）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">电话号码<span class="check-tips">（用于显示的电话号码）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">订单编号<span class="check-tips">（订单的编号）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">地址信息<span class="check-tips">（地址信息栏）</span></label>
			<div class="controls">
				<input type="text" class="text input-small" name="address" value="<?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:'0'); ?>">
			</div>
		</div>

		<div class="form-item">
			<label class="item-label">说明信息<span class="check-tips">（检修信息说明）</span></label>
			<div class="controls">
				<input type="text" class="text input-small" name="info" value="<?php echo (isset($info['info']) && ($info['info'] !== '')?$info['info']:'0'); ?>">
			</div>
		</div>
